...
public static class CloudApi
{
    ...
    private const string hostpg = "https://bf1.127.0.0.1:8080/ping";

    private const string hostaq = "https://bf1.127.0.0.1:8080/api/bf1/autotoggleteam/query";
    private const string hostad = "https://bf1.127.0.0.1:8080/api/bf1/autotoggleteam/add";
    private const string hostar = "https://bf1.127.0.0.1:8080/api/bf1/autotoggleteam/remove";

    private const string hostbq = "https://bf1.127.0.0.1:8080/api/bf1/blacklist/query";
    private const string hostba = "https://bf1.127.0.0.1:8080/api/bf1/blacklist/add";
    private const string hostbr = "https://bf1.127.0.0.1:8080/api/bf1/blacklist/remove";

    private const string kickhistoryad = "https://bf1.127.0.0.1:8080/api/bf1/kickhistory/add";

    private const string toggglehistoryad = "https://bf1.127.0.0.1:8080/api/bf1/togglehistory/add";

    private const string playgamingdatad = "https://bf1.127.0.0.1:8080/api/bf1/playergamingdata/add";

    private const string ruleqr = "https://bf1.127.0.0.1:8080/api/bf1/rule/query";
    private const string rulead = "https://bf1.127.0.0.1:8080/api/bf1/rule/push";

    private const string hostbkad = "https://bf1.127.0.0.1:8080/api/bf1/toggleteambeforekick/add";
    private const string hostbkqr = "https://bf1.127.0.0.1:8080/api/bf1/toggleteambeforekick/query";
    private const string hostbkre = "https://bf1.127.0.0.1:8080/api/bf1/toggleteambeforekick/remove";
    private const string hostbkra = "https://bf1.127.0.0.1:8080/api/bf1/toggleteambeforekick/removeall";

    private const string hostcv = "https://bf1.127.0.0.1:8080/api/bf1/checkversion";
