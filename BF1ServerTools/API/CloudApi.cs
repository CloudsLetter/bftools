...
public static class CloudApi
{
    ...
    public static async Task<RespContent> PushRule(
        ...
        bool whiteTranslateKeyRuleList,
        string translateKeyRules,
        bool translateKeyRulePresetsTooLong,
        bool translateKeyRulePresetsOffensive,
        bool translateKeyRulePresetsWhitespace,
        bool translateKeyRulePresetsMultiline,
        bool translateKeyRulePresetsFakeEnglish,
        ...
        )
    {
        ...
        try
        {
            ...
            var reqBody = new
            {
               ...
               WhiteTranslateKeyRuleList = whiteTranslateKeyRuleList,
               TranslateKeyRules = translateKeyRules,
               TranslateKeyRulePresetsTooLong = translateKeyRulePresetsTooLong,
               TranslateKeyRulePresetsOffensive =  translateKeyRulePresetsOffensive,
               TranslateKeyRulePresetsWhitespace =  translateKeyRulePresetsWhitespace,
               TranslateKeyRulePresetsMultiline =  translateKeyRulePresetsMultiline,
               TranslateKeyRulePresetsFakeEnglish = translateKeyRulePresetsFakeEnglish,
