...
{
    private static string host = Globals.BF1SpartaGateWayAddrProxy + "/jsonrpc/pc/api";
    private const string hostwl = "https://bf1.127.0.0.1:8080/api/bf1/whitelist/query";
    private const string hostla = "https://bf1.127.0.0.1:8080/api/bf1/whitelist/add";
    private const string hostwlr = "https://bf1.127.0.0.1:8080/api/bf1/whitelist/remove";
    private const string hostrule = "https://bf1.127.0.0.1:8080/api/bf1/rule";
    private const string hostmessages = "https://bf1.127.0.0.1:8080/api/bf1/messages/add";
    ...
    public static void SetBF1BF1SpartaGateWayAddrProxy()
    {
        var newOptions = new RestClientOptions(Globals.BF1SpartaGateWayAddrProxy + "/jsonrpc/pc/api")
        {
            MaxTimeout = 5000, // 保留原始设置
            ThrowOnAnyError = true // 保留原始设置
        };
        var newClient = new RestClient(newOptions);
        client = newClient;
